  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: {
          en: "Visit our Affiliates Directory page on this website. Select your region from the dropdown menu to see all CamCCUL-affiliated credit unions in your area, complete with contact information. We have credit unions in all 10 regions of Cameroon — from Bamenda in the Northwest to Maroua in the Far North.",
          fr: "Consultez notre page Annuaire des Affiliés sur ce site. Sélectionnez votre région dans le menu déroulant pour voir toutes les coopératives de crédit affiliées à CamCCUL dans votre zone, avec leurs coordonnées. Nous avons des coopératives de crédit dans les 10 régions du Cameroun — de Bamenda au Nord-Ouest à Maroua à l'Extrême-Nord.",
        },
      },
      {
    ...
    items: [
      {
        ...
        a: {
          ...
          fr: "CamCCUL pilote la digitalisation de ses coopératives de crédit affiliées, rationalisant les opérations et améliorant la prestation de services grâce à des technologies innovantes. Notre feuille de route de digitalisation comprend trois phases : Phase 1 — ce site web public moderne avec annuaire des affiliées, ressources numériques et actualités (déjà en ligne) ; Phase 2 — un système de rapports numériques interne avec validation assistée par IA pour accélérer le traitement des soumissions des affiliées par la Ligue (en développement) ; et Phase 3 — services mobiles, outils d'audit de terrain numériques et système complet de gestion documentaire (planifiée).",
        },
      },
    ],
  },
